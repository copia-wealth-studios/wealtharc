...
defmodule VidarAPI.Connection do
  @moduledoc """
  Handle Tesla connections for VidarAPI.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, VidarAPI.Connection,
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:vidar_api, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - VidarAPI 1.0.0 - elixir"
        )
      )
